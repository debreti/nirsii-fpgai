...
create_clock -period "90 MHz" -name clk_MIPI_clk [get_ports MIPI_PIXEL_CLK]


create_clock -period "133 MHz" -name clk_dram [get_ports DRAM_CLK]
# VGA : 640x480@60Hz
...
set_output_delay -max -clock clk_dram 1.5  [get_ports DRAM_DQ*]
set_output_delay -min -clock clk_dram 0.8 [get_ports DRAM_DQ*]
#
#
...
set_clock_groups -asynchronous -group [get_clocks {CLOCK4_50}] -group [get_clocks {iinst11|pll_sdram_test_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}]
#set_clock_groups -logically_exclusive -group [get_clocks {CLOCK4_50}] -group [get_clocks {inst11|pll_sdram_test_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}]
