-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO10_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO10_block
-- Source Path: testbench/DUT/DUT/Conv Module/Real Conv Kernel/ConvEngine/OutputProcessor_T/OutputProcesssorCoreBusT/HDL_FIFO10
-- Hierarchy Level: 7
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
ENTITY MyProc_src_HDL_FIFO10_block IS
...
END MyProc_src_HDL_FIFO10_block;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO10_block IS

  -- Component Declarations
  COMPONENT MyProc_src_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : MyProc_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.MyProc_src_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_HDL_FIFO10_classic_ram : MyProc_src_SimpleDualPortRAM_singlebit
