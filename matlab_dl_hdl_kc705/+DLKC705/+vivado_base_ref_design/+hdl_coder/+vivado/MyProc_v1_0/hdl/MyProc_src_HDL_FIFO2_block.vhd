-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO2_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO2_block
-- Source Path: testbench/DUT/DUT/Conv Module/Real Conv Kernel/ConvEngine/OutputProcessor_T/OutputProcesssorCoreBusT/HDL_FIFO2
-- Hierarchy Level: 7
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
ENTITY MyProc_src_HDL_FIFO2_block IS
...
END MyProc_src_HDL_FIFO2_block;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO2_block IS
  ...
  SIGNAL w_waddr_1                        : std_logic_vector(5 DOWNTO 0);  -- ufix6
  SIGNAL w_waddr_unsigned                 : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL w_d2                             : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL w_out                            : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL cache_data                       : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL data_out_next                    : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL Out_tmp                          : unsigned(5 DOWNTO 0);  -- ufix6

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_HDL_FIFO2_classic_ram : MyProc_src_SimpleDualPortRAM_generic
  ...
  BEGIN
    IF reset = '1' THEN
      cache_data <= to_unsigned(16#00#, 6);
    ELSIF clk'EVENT AND clk = '1' THEN
