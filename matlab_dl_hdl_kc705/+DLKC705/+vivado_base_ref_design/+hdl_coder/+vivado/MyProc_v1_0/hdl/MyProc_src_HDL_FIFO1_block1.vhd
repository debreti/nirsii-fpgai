-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO1_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO1_block1
-- Source Path: testbench/DUT/DUT/Conv Module/Real Conv Kernel/ConvEngine/OutputProcessor_T/OutputProcesssorCoreBusT/HDL_FIFO1
-- Hierarchy Level: 7
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
ENTITY MyProc_src_HDL_FIFO1_block1 IS
...
END MyProc_src_HDL_FIFO1_block1;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO1_block1 IS
...
BEGIN
  ...
  u_HDL_FIFO1_classic_ram : MyProc_src_SimpleDualPortRAM_singlebit
