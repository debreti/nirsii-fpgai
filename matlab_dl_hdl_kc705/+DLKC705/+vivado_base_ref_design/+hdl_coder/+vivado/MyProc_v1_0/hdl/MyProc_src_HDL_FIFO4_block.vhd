-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO4_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO4_block
-- Source Path: testbench/DUT/DUT/Conv Module/Real Conv Kernel/ConvEngine/OutputProcessor_T/OutputProcesssorCoreBusT/HDL_FIFO4
-- Hierarchy Level: 7
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
ENTITY MyProc_src_HDL_FIFO4_block IS
...
END MyProc_src_HDL_FIFO4_block;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO4_block IS
  ...
  SIGNAL Num_1                            : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL w_waddr_1                        : std_logic_vector(4 DOWNTO 0);  -- ufix5
  SIGNAL w_waddr_unsigned                 : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL w_d2                             : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL w_out                            : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL cache_data                       : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL data_out_next                    : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL Out_tmp                          : unsigned(4 DOWNTO 0);  -- ufix5
...
BEGIN
  ...
  u_HDL_FIFO4_classic_ram : MyProc_src_SimpleDualPortRAM_generic
  ...
  w_cz <= '1' WHEN Num_1 > to_unsigned(16#0#, 3) ELSE
      '0';
  ...
  BEGIN
    IF reset = '1' THEN
      cache_data <= to_unsigned(16#00#, 5);
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Num_tmp <= resize(num_int, 3) + Num_1;
