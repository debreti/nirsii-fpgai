-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO_block2
...
ENTITY MyProc_src_HDL_FIFO_block2 IS
...
END MyProc_src_HDL_FIFO_block2;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO_block2 IS
  ...
  SIGNAL cache_data                       : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL data_out_next                    : unsigned(7 DOWNTO 0);  -- uint8
