-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO_block20.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO_block20
-- Source Path: testbench/DUT/DUT/DDR Write Arbitrator1/HDL_FWFT_FIFO10/For Each Subsystem/HDL_FIFO
-- Hierarchy Level: 5
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
ENTITY MyProc_src_HDL_FIFO_block20 IS
...
END MyProc_src_HDL_FIFO_block20;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO_block20 IS
  ...
  SIGNAL Num_1                            : unsigned(3 DOWNTO 0);  -- ufix4
...
BEGIN
  ...
  w_cz <= '1' WHEN Num_1 > to_unsigned(16#0#, 4) ELSE
      '0';
  ...
  Num_tmp <= resize(num_int, 4) + Num_1;
