-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO_block4
-- Source Path: testbench/DUT/DUT/FC Kernel/Real FC Kernel/FCEngine/FC LC Module/Prog/HDL_FIFO
-- Hierarchy Level: 7
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
ENTITY MyProc_src_HDL_FIFO_block4 IS
...
END MyProc_src_HDL_FIFO_block4;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO_block4 IS
  ...
  SIGNAL Num                              : unsigned(7 DOWNTO 0);  -- ufix8
...
BEGIN
  ...
  fifo_out4 <= '1' WHEN fifo_sample_count = to_unsigned(16#90#, 8) ELSE
      '0';
  ...
  fifo_front_dir_next <= to_unsigned(16#71#, 8) WHEN fifo_front_indx_temp = to_unsigned(16#8F#, 8) ELSE
      to_unsigned(16#01#, 8);
  
  fifo_back_indx_temp <= fifo_back_indx + fifo_back_dir WHEN fifo_write_enable = '1' ELSE
      fifo_back_indx;
  
  fifo_back_dir_next <= to_unsigned(16#71#, 8) WHEN fifo_back_indx_temp = to_unsigned(16#8F#, 8) ELSE
      to_unsigned(16#01#, 8);
  ...
  w_cz <= '1' WHEN Num > to_unsigned(16#00#, 8) ELSE
      '0';
