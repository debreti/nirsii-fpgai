-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_axi4_module
-- Source Path: MyProc/MyProc_axi4/MyProc_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END MyProc_axi4_module;


ARCHITECTURE rtl OF MyProc_axi4_module IS

  -- Component Declarations
  COMPONENT MyProc_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : MyProc_rdfifo_data
    USE ENTITY work.MyProc_rdfifo_data(rtl);

  FOR ALL : MyProc_rdfifo_rid
    USE ENTITY work.MyProc_rdfifo_rid(rtl);

  FOR ALL : MyProc_rdfifo_last
    USE ENTITY work.MyProc_rdfifo_last(rtl);

  FOR ALL : MyProc_reset_hold
    USE ENTITY work.MyProc_reset_hold(rtl);
  ...
  SIGNAL in_burst_out_1                   : std_logic;  -- ufix1
  SIGNAL in_burst_out_2                   : std_logic;  -- ufix1
  SIGNAL in_burst_out_3                   : std_logic;  -- ufix1
  SIGNAL soft_reset_after_hold            : std_logic;  -- ufix1

BEGIN
  u_MyProc_rdfifo_data_inst : MyProc_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_MyProc_rdfifo_rid_inst : MyProc_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_MyProc_rdfifo_last_inst : MyProc_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_MyProc_reset_hold_inst : MyProc_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
              reset_in => soft_reset,  -- ufix1
              in_burst => in_burst_out_3,  -- ufix1
  ...
  in_burst_out <= in_burst_axi4_master_activation_data_rd OR in_burst_axi4_master_activation_data_wr;

  in_burst_out_1 <= in_burst_out OR in_burst_axi4_master_debug_rd;

  in_burst_out_2 <= in_burst_out_1 OR in_burst_axi4_master_debug_wr;

  in_burst_out_3 <= in_burst_out_2 OR in_burst_axi4_master_weight_data_rd;
