-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_axi4_master_debug_rd.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_axi4_master_debug_rd
-- Source Path: MyProc/MyProc_axi4_master_debug_rd
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MyProc_axi4_master_debug_rd IS
...
END MyProc_axi4_master_debug_rd;


ARCHITECTURE rtl OF MyProc_axi4_master_debug_rd IS

  -- Component Declarations
  COMPONENT MyProc_rd_addr_fifo_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT MyProc_rd_len_fifo_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT MyProc_rdata_fifo_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  FOR ALL : MyProc_rd_addr_fifo_block1
    USE ENTITY work.MyProc_rd_addr_fifo_block1(rtl);

  FOR ALL : MyProc_rd_len_fifo_block1
    USE ENTITY work.MyProc_rd_len_fifo_block1(rtl);

  FOR ALL : MyProc_rdata_fifo_block2
    USE ENTITY work.MyProc_rdata_fifo_block2(rtl);
  ...
  SIGNAL write_AXI4_Master_Debug_Rd_base_address_unsigned : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL AXI4_Master_Debug_Rd_ARVALID_1   : std_logic;  -- ufix1
  SIGNAL AXI4_Master_Debug_Rd_ARADDR_tmp  : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL AXI4_Master_Debug_Rd_ARLEN_tmp   : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL AXI4_Master_Debug_Rd_RREADY_1    : std_logic;  -- ufix1
...
BEGIN
  u_MyProc_rd_addr_fifo_inst : MyProc_rd_addr_fifo_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_MyProc_rd_len_fifo_inst : MyProc_rd_len_fifo_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_MyProc_rdata_fifo_inst : MyProc_rdata_fifo_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
              In_rsvd => AXI4_Master_Debug_Rd_RDATA,  -- ufix32
              Push => AXI4_Master_Debug_Rd_RVALID,  -- ufix1
  ...
  write_AXI4_Master_Debug_Rd_base_address_unsigned <= unsigned(write_AXI4_Master_Debug_Rd_base_address);

  full_addr <= user_rd_addr_unsigned + write_AXI4_Master_Debug_Rd_base_address_unsigned;
  ...
  axi4_master_rd_output : PROCESS (AXI4_Master_Debug_Rd_ARREADY, axi4_master_rd_araddr_reg,
  ...
  BEGIN
    ...
    CASE axi4_master_rd_rd_state IS
      ...
      WHEN "00000001" =>
        IF (AXI4_Master_Debug_Rd_ARREADY /= '0') AND axi4_master_rd_arvalid_reg = '1' THEN 
          axi4_master_rd_arvalid_reg_next <= '0';
      ...
      WHEN OTHERS => 
        axi4_master_rd_rd_state_next <= to_unsigned(16#00#, 8);
    END CASE;
    AXI4_Master_Debug_Rd_ARVALID_1 <= axi4_master_rd_arvalid_reg;
    AXI4_Master_Debug_Rd_ARADDR_tmp <= axi4_master_rd_araddr_reg;
    AXI4_Master_Debug_Rd_ARLEN_tmp <= axi4_master_rd_arlen_reg;
    AXI4_Master_Debug_Rd_ARID <= axi4_master_rd_rd_arid_reg;
  END PROCESS axi4_master_rd_output;


  AXI4_Master_Debug_Rd_ARADDR <= std_logic_vector(AXI4_Master_Debug_Rd_ARADDR_tmp);

  AXI4_Master_Debug_Rd_ARLEN <= std_logic_vector(AXI4_Master_Debug_Rd_ARLEN_tmp);

  const_arsize <= to_unsigned(16#2#, 3);

  AXI4_Master_Debug_Rd_ARSIZE <= std_logic_vector(const_arsize);

  const_1_2 <= to_unsigned(16#1#, 2);

  AXI4_Master_Debug_Rd_ARBURST <= std_logic_vector(const_1_2);

  const_0_1 <= '0';

  AXI4_Master_Debug_Rd_ARLOCK <= const_0_1;

  const_3_4 <= to_unsigned(16#3#, 4);

  AXI4_Master_Debug_Rd_ARCACHE <= std_logic_vector(const_3_4);

  const_0_3 <= to_unsigned(16#0#, 3);

  AXI4_Master_Debug_Rd_ARPROT <= std_logic_vector(const_0_3);
  ...
  AXI4_Master_Debug_Rd_RREADY_1 <=  NOT rdata_fifo_full;
  ...
  ar_transfer <= AXI4_Master_Debug_Rd_ARREADY AND AXI4_Master_Debug_Rd_ARVALID_1;

  const_0_9 <= to_unsigned(16#000#, 9);

  const_1_9 <= to_unsigned(16#001#, 9);

  arlen_plusone <= resize(AXI4_Master_Debug_Rd_ARLEN_tmp, 9) + const_1_9;

  
  ar_transfer_len <= const_0_9 WHEN ar_transfer = '0' ELSE
      arlen_plusone;

  r_transfer <= AXI4_Master_Debug_Rd_RREADY_1 AND AXI4_Master_Debug_Rd_RVALID;
  ...
  in_burst_axi4_master_debug_rd <= '1' WHEN accum_value > to_signed(0, 32) ELSE
      '0';

  AXI4_Master_Debug_Rd_ARVALID <= AXI4_Master_Debug_Rd_ARVALID_1;

  AXI4_Master_Debug_Rd_RREADY <= AXI4_Master_Debug_Rd_RREADY_1;
