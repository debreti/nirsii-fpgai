-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO_block11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO_block11
...
ENTITY MyProc_src_HDL_FIFO_block11 IS
...
END MyProc_src_HDL_FIFO_block11;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO_block11 IS
  ...
  SIGNAL fifo_front_indx                  : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_front_dir                   : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_back_indx                   : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_back_dir                    : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_sample_count                : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_front_indx_next             : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_front_dir_next              : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_back_indx_next              : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_back_dir_next               : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_sample_count_next           : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_out3                        : std_logic;
  SIGNAL fifo_out4                        : std_logic;
  SIGNAL fifo_write_enable                : std_logic;
  SIGNAL fifo_read_enable                 : std_logic;
  SIGNAL fifo_front_indx_temp             : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL fifo_back_indx_temp              : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL w_waddr                          : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL w_we                             : std_logic;  -- ufix1
  SIGNAL w_raddr                          : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL Empty_1                          : std_logic;  -- ufix1
  SIGNAL Num_1                            : unsigned(4 DOWNTO 0);  -- ufix5
  ...
  SIGNAL w_waddr_signed                   : signed(7 DOWNTO 0);  -- int8
  SIGNAL w_d2                             : signed(7 DOWNTO 0);  -- int8
  SIGNAL w_out                            : signed(7 DOWNTO 0);  -- int8
  SIGNAL cache_data                       : signed(7 DOWNTO 0);  -- int8
  SIGNAL data_out_next                    : signed(7 DOWNTO 0);  -- int8
...
BEGIN
  ...
  u_HDL_FIFO_classic_ram : MyProc_src_SimpleDualPortRAM_generic
  ...
  BEGIN
    IF reset = '1' THEN
      fifo_front_indx <= to_unsigned(16#00#, 5);
      fifo_front_dir <= to_unsigned(16#01#, 5);
      fifo_back_indx <= to_unsigned(16#00#, 5);
      fifo_back_dir <= to_unsigned(16#01#, 5);
  ...
  fifo_out4 <= '1' WHEN fifo_sample_count = to_unsigned(16#12#, 5) ELSE
      '0';
  ...
  fifo_front_dir_next <= to_unsigned(16#0F#, 5) WHEN fifo_front_indx_temp = to_unsigned(16#11#, 5) ELSE
      to_unsigned(16#01#, 5);
  
  fifo_back_indx_temp <= fifo_back_indx + fifo_back_dir WHEN fifo_write_enable = '1' ELSE
      fifo_back_indx;
  
  fifo_back_dir_next <= to_unsigned(16#0F#, 5) WHEN fifo_back_indx_temp = to_unsigned(16#11#, 5) ELSE
      to_unsigned(16#01#, 5);
  ...
  w_cz <= '1' WHEN Num_1 > to_unsigned(16#00#, 5) ELSE
      '0';
  ...
  Num_tmp <= resize(num_int, 5) + Num_1;
