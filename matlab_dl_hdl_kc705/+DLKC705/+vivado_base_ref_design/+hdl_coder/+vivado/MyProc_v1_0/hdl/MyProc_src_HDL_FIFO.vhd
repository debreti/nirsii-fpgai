-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO
-- Source Path: testbench/DUT/DUT/Scheduler/Scheduler/DDRInterface/Subsystem/ModifiedForBoth/HDL_FIFO
-- Hierarchy Level: 7
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
END MyProc_src_HDL_FIFO;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO IS
  ...
  SIGNAL fifo_front_indx                  : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_front_dir                   : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_back_indx                   : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_back_dir                    : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_sample_count                : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_front_indx_next             : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_front_dir_next              : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_back_indx_next              : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_back_dir_next               : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_sample_count_next           : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_out3                        : std_logic;
  SIGNAL fifo_out4                        : std_logic;
  SIGNAL fifo_write_enable                : std_logic;
  SIGNAL fifo_read_enable                 : std_logic;
  SIGNAL fifo_front_indx_temp             : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL fifo_back_indx_temp              : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL w_waddr                          : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL w_we                             : std_logic;  -- ufix1
  SIGNAL w_raddr                          : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL Empty_1                          : std_logic;  -- ufix1
  SIGNAL Num                              : unsigned(5 DOWNTO 0);  -- ufix6
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      fifo_front_indx <= to_unsigned(16#00#, 6);
      fifo_front_dir <= to_unsigned(16#01#, 6);
      fifo_back_indx <= to_unsigned(16#00#, 6);
      fifo_back_dir <= to_unsigned(16#01#, 6);
      fifo_sample_count <= to_unsigned(16#00#, 6);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  fifo_out4 <= '1' WHEN fifo_sample_count = to_unsigned(16#30#, 6) ELSE
      '0';
  
  fifo_out3 <= '1' WHEN fifo_sample_count = to_unsigned(16#00#, 6) ELSE
      '0';
  ...
  fifo_front_dir_next <= to_unsigned(16#11#, 6) WHEN fifo_front_indx_temp = to_unsigned(16#2F#, 6) ELSE
      to_unsigned(16#01#, 6);
  
  fifo_back_indx_temp <= fifo_back_indx + fifo_back_dir WHEN fifo_write_enable = '1' ELSE
      fifo_back_indx;
  
  fifo_back_dir_next <= to_unsigned(16#11#, 6) WHEN fifo_back_indx_temp = to_unsigned(16#2F#, 6) ELSE
      to_unsigned(16#01#, 6);
  
  fifo_sample_count_next <= fifo_sample_count + to_unsigned(16#01#, 6) WHEN (fifo_write_enable AND ( NOT fifo_read_enable)) = '1' ELSE
      fifo_sample_count + to_unsigned(16#3F#, 6) WHEN (( NOT fifo_write_enable) AND fifo_read_enable) = '1' ELSE
      fifo_sample_count;
  ...
  w_cz <= '1' WHEN Num > to_unsigned(16#00#, 6) ELSE
      '0';
