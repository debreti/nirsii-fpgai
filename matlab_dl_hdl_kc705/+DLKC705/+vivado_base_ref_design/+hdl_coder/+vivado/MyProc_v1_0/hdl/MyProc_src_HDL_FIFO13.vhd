-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO13
-- Source Path: testbench/DUT/DUT/Conv Module/Real Conv Kernel/ConvEngine/InputProcessor0_T/InputProcesssorCoreBusT/HDL_FIFO13
-- Hierarchy Level: 7
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
ENTITY MyProc_src_HDL_FIFO13 IS
...
END MyProc_src_HDL_FIFO13;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO13 IS
...
BEGIN
  ...
  u_HDL_FIFO13_classic_ram_singlebit : MyProc_src_SimpleDualPortRAM_singlebit
