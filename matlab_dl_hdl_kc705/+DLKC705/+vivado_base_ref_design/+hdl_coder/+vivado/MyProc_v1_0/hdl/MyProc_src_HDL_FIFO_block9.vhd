-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO_block9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO_block9
-- Source Path: testbench/DUT/DUT/Conv Module/Real Conv Kernel/ConvEngine/CONV/Conv_Sync/SyncedProcessorDynamicLCLoading/Prog/HDL_FIFO
-- Hierarchy Level: 9
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
ENTITY MyProc_src_HDL_FIFO_block9 IS
...
END MyProc_src_HDL_FIFO_block9;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO_block9 IS
  ...
  SIGNAL fifo_sample_count                : unsigned(9 DOWNTO 0);  -- ufix10
  ...
  SIGNAL fifo_sample_count_next           : unsigned(9 DOWNTO 0);  -- ufix10
...
BEGIN
  ...
  u_HDL_FIFO_classic_ram_generic : MyProc_src_SimpleDualPortRAM_generic
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      fifo_sample_count <= to_unsigned(16#000#, 10);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  fifo_out4 <= '1' WHEN fifo_sample_count = to_unsigned(16#2F4#, 10) ELSE
      '0';
  
  fifo_out3 <= '1' WHEN fifo_sample_count = to_unsigned(16#000#, 10) ELSE
      '0';
  ...
  fifo_front_dir_next <= to_unsigned(16#10D#, 10) WHEN fifo_front_indx_temp = to_unsigned(16#2F3#, 10) ELSE
      to_unsigned(16#001#, 10);
  
  fifo_back_indx_temp <= fifo_back_indx + fifo_back_dir WHEN fifo_write_enable = '1' ELSE
      fifo_back_indx;
  
  fifo_back_dir_next <= to_unsigned(16#10D#, 10) WHEN fifo_back_indx_temp = to_unsigned(16#2F3#, 10) ELSE
      to_unsigned(16#001#, 10);
  
  fifo_sample_count_next <= fifo_sample_count + to_unsigned(16#001#, 10) WHEN (fifo_write_enable AND ( NOT fifo_read_enable)) = '1' ELSE
      fifo_sample_count + to_unsigned(16#3FF#, 10) WHEN (( NOT fifo_write_enable) AND fifo_read_enable) = '1' ELSE
      fifo_sample_count;
  ...
  w_cz <= '1' WHEN Num > to_unsigned(16#000#, 10) ELSE
      '0';
