-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_axi4_master_debug_wr.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_axi4_master_debug_wr
-- Source Path: MyProc/MyProc_axi4_master_debug_wr
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MyProc_axi4_master_debug_wr IS
...
END MyProc_axi4_master_debug_wr;


ARCHITECTURE rtl OF MyProc_axi4_master_debug_wr IS

  -- Component Declarations
  COMPONENT MyProc_wdata_fifo_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT MyProc_wr_addr_fifo_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT MyProc_wr_data_fifo_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT MyProc_wr_len_fifo_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT MyProc_wlast_fifo_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : MyProc_wdata_fifo_block1
    USE ENTITY work.MyProc_wdata_fifo_block1(rtl);

  FOR ALL : MyProc_wr_addr_fifo_block
    USE ENTITY work.MyProc_wr_addr_fifo_block(rtl);

  FOR ALL : MyProc_wr_data_fifo_block1
    USE ENTITY work.MyProc_wr_data_fifo_block1(rtl);

  FOR ALL : MyProc_wr_len_fifo_block
    USE ENTITY work.MyProc_wr_len_fifo_block(rtl);

  FOR ALL : MyProc_wlast_fifo_block
    USE ENTITY work.MyProc_wlast_fifo_block(rtl);
  ...
  SIGNAL write_AXI4_Master_Debug_Wr_base_address_unsigned : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL axi4_master_wr_wr_awid_reg       : std_logic;  -- ufix1
  ...
  SIGNAL axi4_master_wr_awid_reg          : std_logic;  -- ufix1
  ...
  SIGNAL axi4_master_wr_wr_awid_reg_next  : std_logic;  -- ufix1
  ...
  SIGNAL axi4_master_wr_awid_reg_next     : std_logic;  -- ufix1
  SIGNAL axi4_master_wr_wvalid_reg_next   : std_logic;
  SIGNAL axi4_master_wr_wlast_reg_next    : std_logic;
  SIGNAL AXI4_Master_Debug_Wr_AWVALID_1   : std_logic;  -- ufix1
  SIGNAL AXI4_Master_Debug_Wr_AWADDR_tmp  : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL AXI4_Master_Debug_Wr_AWLEN_tmp   : unsigned(7 DOWNTO 0);  -- ufix8
...
BEGIN
  u_MyProc_wdata_fifo_inst : MyProc_wdata_fifo_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
              ...
              Out_rsvd => AXI4_Master_Debug_Wr_WDATA_tmp,  -- ufix32
              Empty => out_fifo_empty,  -- ufix1
              AFull => out_fifo_afull  -- ufix1
              );

  u_MyProc_wr_addr_fifo_inst : MyProc_wr_addr_fifo_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_MyProc_wr_data_fifo_inst : MyProc_wr_data_fifo_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_MyProc_wr_len_fifo_inst : MyProc_wr_len_fifo_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_MyProc_wlast_fifo_inst : MyProc_wlast_fifo_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
              ...
              Push => out_fifo_push,  -- ufix1
              Pop => out_fifo_ack,  -- ufix1
              Out_rsvd => AXI4_Master_Debug_Wr_WLAST  -- ufix1
              );
  ...
  write_AXI4_Master_Debug_Wr_base_address_unsigned <= unsigned(write_AXI4_Master_Debug_Wr_base_address);

  full_addr <= user_wr_addr_unsigned + write_AXI4_Master_Debug_Wr_base_address_unsigned;
  ...
  out_fifo_ack <= AXI4_Master_Debug_Wr_WREADY AND wvalid_internal;
  ...
  axi4_master_wr_output : PROCESS (AXI4_Master_Debug_Wr_AWREADY, axi4_master_wr_addr_done_reg,
  ...
  BEGIN
    ...
    CASE axi4_master_wr_wr_astate IS
      ...
      WHEN "00000001" =>
        addr_done_reg_temp := '0';
        IF axi4_master_wr_awvalid_reg = '1' AND (AXI4_Master_Debug_Wr_AWREADY /= '0') THEN 
    ...
    CASE axi4_master_wr_wr_dstate IS
      ...
      WHEN OTHERS => 
        ...
        axi4_master_wr_wr_dstate_next <= to_unsigned(16#00#, 8);
    END CASE;
    AXI4_Master_Debug_Wr_AWVALID_1 <= axi4_master_wr_awvalid_reg;
    AXI4_Master_Debug_Wr_AWADDR_tmp <= axi4_master_wr_awaddr_reg;
    AXI4_Master_Debug_Wr_AWLEN_tmp <= axi4_master_wr_awlen_reg;
    AXI4_Master_Debug_Wr_AWID <= axi4_master_wr_awid_reg;
  ...
  AXI4_Master_Debug_Wr_AWADDR <= std_logic_vector(AXI4_Master_Debug_Wr_AWADDR_tmp);

  AXI4_Master_Debug_Wr_AWLEN <= std_logic_vector(AXI4_Master_Debug_Wr_AWLEN_tmp);

  const_awsize <= to_unsigned(16#2#, 3);

  AXI4_Master_Debug_Wr_AWSIZE <= std_logic_vector(const_awsize);

  const_1_2 <= to_unsigned(16#1#, 2);

  AXI4_Master_Debug_Wr_AWBURST <= std_logic_vector(const_1_2);

  const_0_1 <= '0';

  AXI4_Master_Debug_Wr_AWLOCK <= const_0_1;

  const_3_4 <= to_unsigned(16#3#, 4);

  AXI4_Master_Debug_Wr_AWCACHE <= std_logic_vector(const_3_4);

  const_0_3 <= to_unsigned(16#0#, 3);

  AXI4_Master_Debug_Wr_AWPROT <= std_logic_vector(const_0_3);

  const_wstrb <= to_unsigned(16#F#, 4);

  AXI4_Master_Debug_Wr_WSTRB <= std_logic_vector(const_wstrb);

  AXI4_Master_Debug_Wr_WVALID <= wvalid_internal;

  AXI4_Master_Debug_Wr_BREADY <= const_1_1;

  user_wr_ready <=  NOT wr_fifo_afull;

  user_wr_complete <= wr_complete_internal;

  aw_transfer <= AXI4_Master_Debug_Wr_AWREADY AND AXI4_Master_Debug_Wr_AWVALID_1;
  ...
  w_transfer <= const_1_1 AND AXI4_Master_Debug_Wr_BVALID;
  ...
  in_burst_axi4_master_debug_wr <= '1' WHEN accum_value > to_signed(0, 32) ELSE
      '0';

  AXI4_Master_Debug_Wr_AWVALID <= AXI4_Master_Debug_Wr_AWVALID_1;
