-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_src_HDL_FIFO7_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_src_HDL_FIFO7_block
-- Source Path: testbench/DUT/DUT/Conv Module/Real Conv Kernel/ConvEngine/OutputProcessor_T/OutputProcesssorCoreBusT/HDL_FIFO7
-- Hierarchy Level: 7
-- Model version: 8.28
-- 
-- -------------------------------------------------------------
...
ENTITY MyProc_src_HDL_FIFO7_block IS
...
END MyProc_src_HDL_FIFO7_block;


ARCHITECTURE rtl OF MyProc_src_HDL_FIFO7_block IS
  ...
  SIGNAL cache_data                       : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL data_out_next                    : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL Out_tmp                          : unsigned(2 DOWNTO 0);  -- ufix3

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_HDL_FIFO7_classic_ram : MyProc_src_SimpleDualPortRAM_generic
