-- -------------------------------------------------------------
-- 
-- File Name: customProc\hdlsrc\testbench\MyProc_wr_data_fifo_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MyProc_wr_data_fifo_block
-- Source Path: MyProc/MyProc_axi4_master_activation_data_wr/MyProc_wr_data_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MyProc_wr_data_fifo_block IS
...
END MyProc_wr_data_fifo_block;


ARCHITECTURE rtl OF MyProc_wr_data_fifo_block IS

  -- Component Declarations
  COMPONENT MyProc_SimpleDualPortRAM_generic
  ...
  FOR ALL : MyProc_SimpleDualPortRAM_generic
    USE ENTITY work.MyProc_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_MyProc_wr_data_fifo_classic_ram : MyProc_SimpleDualPortRAM_generic
