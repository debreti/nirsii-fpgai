...
2. **Оптимизация памяти**: AI Engine имеет локальную память (scratchpad) на каждом ядре. Компилятор автоматически оптимизирует доступы к памяти, но на этапе проектирования важно понимать, что глубокие конвоярные структуры требуют больше буферизации.
