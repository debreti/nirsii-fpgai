...
Одной из особенностей инструментов для разработки Edge AI решений является поддержка функционала разных этапов, например глубокого обучния и оптимизации (PyTorch) или наличие тесной взаимосвязи между инструментами от одного разработчика (OpenVINO, FPGA AI Suite, Quartus Prime).
...
* [3.6.1 OneWare: экосистема для ускоренной разарботки Edge AI на FPGA](ch3.6.1.md#ch3.6.1)
