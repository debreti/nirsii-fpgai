# Реализация нейронных сетей на FPGA с помощью MATLAB: подробный разбор с двумя примерами реализации <a name="ch4.2"></a>
