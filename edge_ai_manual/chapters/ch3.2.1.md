...
<figure>
  <img src="../assets/image_3_2_1_1.png" alt="PyTorch в классификации" width="400" style="float:right; margin: 7px 7px 7px 20px"/>
</figure>
...
Если падение точности выходит за пределы допустимого, разработчик может изменить архитектуру, пересмотреть нормализацию, провести квантование-предобучение ([QAT](glossary.md#qat)) или использовать смешанную точность слоёв.
...
**Официальный ресурс:** ([PyTorch](https://pytorch.org/)).
