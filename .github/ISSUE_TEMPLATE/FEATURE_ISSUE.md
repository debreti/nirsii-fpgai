...
about: Want us to add any features to nirsii-fpgai?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with nirsii-fpgai. Please take the time to
...
<!--
  Why do you want to see this feature in nirsii-fpgai? What use cases does it support?
-->
